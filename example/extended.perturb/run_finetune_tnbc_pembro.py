...
output_dir  = f"/media/stu.backup2/Qian/ivy.codes/cancerstformer/data/Extended.model/{datestamp}"
os.makedirs(output_dir,exist_ok=True)

input_dataset = "/media/stu.backup2/Qian/ivy.codes/cancerstformer/data/Extended.model/STFormer_TNBC_neighbor.dataset"
num_trials = 2
...
all_metrics = cc.validate(model_directory="/media/stu.backup2/Qian/ivy.codes/cancerstformer/data/Extended.model/spatial_models",
prepared_input_data_file=f"{output_dir}/{output_prefix}_labeled.dataset",
id_class_dict_file=f"{output_dir}/{output_prefix}_id_class_dict.pkl",
o_directory=output_dir,  o_prefix=output_prefix, n_hyperopt_trials=num_trials)
