...
if __name__=="__main__":
	...
	if goldstd=="basal":
		...
		sys.exit(0)
	#by_ligand = read_lr_targets("../../tnbc.responder.spatialmodel/pembro/shuf1/test/TNBC.PDCD1.targets.100.txt")
	#by_ligand = read_lr_targets("../../tnbc.responder.spatialmodel/pembro/shuf1/test/TNBC.PDCD1.targets.200.txt") #good
	#by_ligand = read_lr_targets("../../tnbc.responder.spatialmodel/pembro/shuf1/TNBC.PDCD1.targets.txt")
	#print(by_ligand)
